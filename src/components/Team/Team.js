  ...
  return (
    <div className="team text-light">
      <div className="team--header text-center py-5">
        <img
          src={currentTeam[0]?.strStadiumThumb}
          alt={`${currentTeam[0]?.strTeam} stadium`}
          className="team--bg"
        />
        <div className="team--logo">
          <img
            src={currentTeam[0]?.strTeamBadge}
            alt={`${currentTeam[0]?.strTeam} logo`}
          />
        </div>
      </div>
          ...
          <div className="col-lg-8 col-md-5 col-sm-12">
            ...
            <div className="team--info">
              <p>
                ...
                {currentTeam[0]?.intFormedYear}
              </p>
              <p>
                <FontAwesomeIcon icon={faFlag} /> Country:{" "}
                {currentTeam[0]?.strCountry}
              </p>
              <p>
                <FontAwesomeIcon icon={faFutbol} /> Sport Type:{" "}
                {currentTeam[0]?.strSport}
              </p>
              <p>
                <FontAwesomeIcon icon={faMars} /> Gender:{" "}
                {currentTeam[0]?.strGender}
              </p>
            </div>
          </div>
          <div className="col-lg-4 col-md-7 col-sm-12">
            <img
              src={currentTeam[0]?.strTeamFanart4}
              alt={`${currentTeam[0]?.strTeam} banner`}
              className="img-fluid"
            />
          </div>
        </div>
        ...
        <div className="row mt-4">
          <div className="team--links text-center">
            ...
            <ul className="mt-3">
              <li>
                <a
                  href={`https://${currentTeam[0]?.strFacebook}`}
                  target="_blank"
              ...
              <li>
                <a
                  href={`https://${currentTeam[0]?.strTwitter}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-primary"
                >
              ...
              <li>
                <a
                  href={`https://${currentTeam[0]?.strInstagram}`}
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <li>
                <a
                  href={`https://${currentTeam[0]?.strYoutube}`}
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <li>
                <a
                  href={`https://${currentTeam[0]?.strWebsite}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-info"
                >
